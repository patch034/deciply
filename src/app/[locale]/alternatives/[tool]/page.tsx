...
const copy = {
  tr: {
    ...
    pricingDescription: "Ücretsiz başlama noktası, ticari kullanım ve kısa değer önerisini aynı bölümde görün.",
      ...
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-10 px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
        ...
        <InfoSection title={dictionary.bestForTitle} description={dictionary.bestForDescription}>
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            {alternatives.map((item) => (
              <div key={item.slug} className="rounded-[24px] border border-slate-700/60 bg-slate-950/60 p-5 shadow-card">
