...
export function TopPickSection({ locale, content }: TopPickSectionProps) {
  return (
    ...
    >
      <GlassPanel className="relative overflow-hidden rounded-[28px] border border-fuchsia-400/18 bg-[linear-gradient(160deg,rgba(17,24,39,0.96),rgba(9,13,23,0.99))] px-6 py-7 shadow-[0_30px_88px_-44px_rgba(14,165,233,0.22),0_0_0_1px_rgba(217,70,239,0.06)] lg:px-8 lg:py-8">
        ...
        <div className="relative grid gap-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          ...
          <div className="ui-inner-panel border border-cyan-400/15 p-5 shadow-[0_20px_56px_-36px_rgba(34,211,238,0.34)]">
            <div className="grid gap-4">
              ...
              <div className="rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-sm font-medium text-cyan-100/92 shadow-[0_16px_36px_-28px_rgba(34,211,238,0.34)]">
                {content.benefitLine}
              </div>
