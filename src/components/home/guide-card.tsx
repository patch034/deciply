...
export function GuideCard({ locale, item, linkLabel, tone = "light" }: GuideCardProps) {
  ...
  return (
    <Link href={`/${locale}${item.href}`} className="group block h-full">
      <article
        className={[
          "ui-card ui-card-hover home-card-glow flex h-full min-h-[240px] flex-col overflow-hidden rounded-[24px] p-5 transition duration-300 hover:-translate-y-1 sm:min-h-[260px] sm:p-5 md:p-6",
          light
