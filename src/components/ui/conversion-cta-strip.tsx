...
export function ConversionCtaStrip({ eyebrow, title, description, buttons, className }: ConversionCtaStripProps) {
  return (
    <section
      className={clsx(
        "rounded-[30px] border border-white/10 bg-[linear-gradient(135deg,rgba(15,23,42,0.98),rgba(11,15,25,0.98))] px-5 py-7 shadow-[0_24px_70px_-40px_rgba(34,211,238,0.2)] sm:px-6 sm:py-8 lg:px-10 lg:py-12",
        className
      )}
    >
