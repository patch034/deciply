...
export function SiteFooter({ locale, dictionary }: SiteFooterProps) {
  ...
  return (
    <footer className="mt-20 px-6 pb-8">
      <GlassPanel className="mx-auto max-w-[1200px] rounded-2xl border-violet-400/14 bg-[linear-gradient(180deg,rgba(2,4,9,0.98),rgba(8,12,22,0.98))] px-6 py-10 shadow-[0_28px_80px_-44px_rgba(6,10,18,0.72)]">
