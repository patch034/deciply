...
export function ComparisonFaq({ title, description, items }: ComparisonFaqProps) {
  return (
    <section className="rounded-[28px] border border-white/10 bg-[linear-gradient(180deg,rgba(17,24,39,0.92),rgba(15,23,42,0.9))] p-5 shadow-card md:p-8">
      ...
      <div className="mt-6 grid gap-3 sm:mt-8">
        {items.map((item) => (
          <details key={item.question} className="group rounded-[22px] border border-white/10 bg-white/[0.04] p-4 transition open:bg-white/[0.05] sm:rounded-[24px] sm:p-5">
