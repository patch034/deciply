...
export function CategoryNavigationHub({ locale, categories, copy }: CategoryNavigationHubProps) {
  ...
  return (
    <div className="grid items-start gap-5 lg:grid-cols-[260px_minmax(0,1fr)]">
      <aside className="category-sticky-sidebar">
        <div className="rounded-[18px] border border-slate-200 bg-white p-2">
          ...
          <nav className="homepage-horizontal-scroll flex gap-2 overflow-x-auto pb-1 lg:flex-col lg:gap-1 lg:overflow-visible lg:pr-0">
            {categories.map((category) => {
              ...
              return (
                <a
                  ...
                  className={[
                    "group flex min-w-[12rem] cursor-pointer items-center justify-between gap-3 rounded-[12px] border border-l-[3px] px-3 py-2.5 text-left transition duration-150 lg:min-w-0 lg:py-1.5",
                    active
