...
export function CategoryHero({
  ...
  return (
    <section className="rounded-[32px] border border-sky-400/10 bg-[linear-gradient(135deg,rgba(15,23,42,0.84),rgba(11,15,25,0.94))] p-8 shadow-[0_24px_80px_-44px_rgba(14,165,233,0.12)] md:p-10">
