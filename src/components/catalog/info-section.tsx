...
export function InfoSection({ id, title, description, children, className }: InfoSectionProps) {
  return (
    <section
      id={id}
      className={clsx("rounded-[28px] border border-sky-400/10 bg-[linear-gradient(180deg,rgba(17,24,39,0.92),rgba(15,23,42,0.9))] p-6 shadow-[0_24px_80px_-44px_rgba(14,165,233,0.12)] md:p-8", className)}
    >
