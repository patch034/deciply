...
export function StaticPageShell({ content }: StaticPageShellProps) {
  return (
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-8 px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
      <section className="rounded-[36px] border border-white/8 bg-[linear-gradient(135deg,rgba(6,10,19,0.94),rgba(10,16,30,0.95),rgba(4,7,12,0.98))] px-8 py-10 shadow-[0_30px_90px_-46px_rgba(34,211,238,0.18)] lg:px-10 lg:py-12">
        ...
        <div className="mt-8 rounded-[24px] border border-white/8 bg-[linear-gradient(180deg,rgba(255,255,255,0.04),rgba(255,255,255,0.015))] p-6 text-sm leading-8 text-slate-300 md:text-base">
          {content.intro}
        </div>
      </section>
      ...
      <div className="space-y-6">
        {content.sections.map((section) => (
          <section
            key={section.title}
            className="rounded-[28px] border border-white/8 bg-[linear-gradient(180deg,rgba(12,18,33,0.92),rgba(8,13,24,0.94))] p-6 shadow-[0_22px_60px_-40px_rgba(6,10,18,0.72)] md:p-8"
          >
