...
const allBlogArticles: BlogEntry[] = [
  ...
  },
  {
    ...
    locales: {
      tr: {
        title: "ChatGPT vs Claude vs Gemini kar_1la_t1rma (2026)",
        excerpt:
          "Bu rehber tek bir kazanan se�mez. Yaz1, ara_t1rma, h1z, doruluk ve g�nl�k kullan1m taraf1nda �� arac1 senaryo bazl1 ay1r1r.",
        intro:
          "ChatGPT, Claude ve Gemini ayn1 ihtiyac1 ��z�yor gibi g�r�nse de pratikte farkl1 g��l� y�nler ta_1r. Biri h1zl1 taslak ve �ok y�nl� kullan1mda rahat olabilir, biri daha uzun ve d�zenli anlat1mda �ne �1kabilir, biri ise Google tabanl1 ak1_larda daha doal hissedebilir. Bu kar_1la_t1rma, fanboy dili kullanmadan hangi senaryoda hangisinin daha mant1kl1 olduunu g�stermek i�in haz1rland1.",
        categoryLabel: "Kar_1la_t1rmalar",
        seoTitle: "ChatGPT vs Claude vs Gemini kar_1la_t1rma (2026) | Deciply",
        seoDescription:
          "ChatGPT, Claude ve Gemini ara�lar1n1 yaz1, ara_t1rma, kullan1m kolayl11, fiyat ve i_ ak1_1 a�1s1ndan tarafs1z bi�imde kar_1la_t1r1n.",
        sections: [
          section(
...
,
  {
    ...
    locales: {
      tr: {
        title: "Freelancer'lar i�in AI ara�lar1",
        excerpt: "Freelancer olarak daha h1zl1 teslim vermek, daha d�zenli �al1_mak ve daha karl1 paketler haz1rlamak i�in hangi AI ara�lar1n1n mant1kl1 olduunu g�steren rehber.",
        intro: "Freelancer i�in zaman dorudan marjd1r. Ayn1 i_i daha k1sa s�rede teslim etmek �ou zaman doru ara� se�imiyle ilgilidir. Bu rehberde [ChatGPT](/tr/tools/chatgpt), [Claude](/tr/tools/claude), [Perplexity](/tr/tools/perplexity), [Canva AI](/tr/tools/canva-ai), [Runway](/tr/tools/runway) ve [Notion AI](/tr/tools/notion-ai) gibi ara�lar1n freelance i_ ak1_1ndaki yerini inceliyoruz.",
        categoryLabel: "Rehberler",
        seoTitle: "Freelancer'lar i�in AI ara�lar1 | Deciply",
        seoDescription: "Freelancer'lar i�in en mant1kl1 AI ara�lar1n1 yaz1, ara_t1rma, tasar1m, video ve m�_teri teslimi a�1s1ndan inceleyin.",
        sections: [
          section("H1zl1 �zet", ["Freelancer i�in en mant1kl1 ara�, en pop�ler olan deil; teslim s�resini d�_�ren ve teklif deerini y�kselten ara�t1r.", "Bilgi tabanl1 i_lerde [ChatGPT](/tr/tools/chatgpt) ve [Claude](/tr/tools/claude), ara_t1rma youn i_lerde [Perplexity](/tr/tools/perplexity), h1zl1 g�rsel teslimde [Canva AI](/tr/tools/canva-ai) ve k1sa videoda [Runway](/tr/tools/runway) daha mant1kl1 hale gelebilir."], { comparison: { title: "Freelance kullan1m haritas1", items: [ { label: "Yaz1 ve taslak", value: "ChatGPT / Claude" }, { label: "Ara_t1rma", value: "Perplexity" }, { label: "G�rsel teslim", value: "Canva AI" }, { label: "Video", value: "Runway" } ] } }),
          section("Bu i�erik kimler i�in?", ["0�erik yazar1, dan1_man, sosyal medya y�neticisi, solo ajans sahibi veya k���k m�_teri i_leri alan herkes i�in uygundur.", "�zellikle daha d�zenli �al1_mak isteyen ama ara� kalabal11nda boulmak istemeyen kullan1c1ya hitap eder."], { bullets: ["0�erik freelancer'lar1", "Dan1_manlar", "Sosyal medya y�neticileri", "Solo operat�rler"] }),
          section("En mant1kl1 ara�lar ve stratejiler", ["Metin ve i�erik teslim ediyorsan ilk durak genelde [ChatGPT](/tr/tools/chatgpt) veya [Claude](/tr/tools/claude) olur.", "M�_teri �ncesi ara_t1rma ve rakip analizi gerekiyorsa [Perplexity](/tr/tools/perplexity) ciddi zaman kazand1rabilir. Sosyal medya veya sunum teslimi yap1yorsan [Canva AI](/tr/tools/canva-ai) daha pratik olabilir."], { subSections: [ sub("Yaz1 ve ara_t1rma odakl1 i_ler", ["Blog, landing page, e-posta veya ara_t1rma �zeti sat1yorsan yaz1 ve kaynak odakl1 ara�lara �ncelik vermek daha sal1kl1d1r.", "Bu senaryoda �nce [ChatGPT](/tr/tools/chatgpt) veya [Claude](/tr/tools/claude), sonra gerekirse [Perplexity](/tr/tools/perplexity) eklemek �ou kullan1c1 i�in yeterlidir."], ["Blog yaz1s1", "E-posta seti", "Ara_t1rma �zeti"], "Yaz1 ara�lar1n1 g�r", "/tr/categories/ai-tools"), sub("Tasar1m ve i�erik paketi", ["Sosyal medya g�rseli, sunum veya k1sa video sat1yorsan [Canva AI](/tr/tools/canva-ai) ve [Runway](/tr/tools/runway) daha y�ksek kald1ra� salar.", "Bu ara�lar �zellikle teslim h1z1n1n teklif d�n�_�m�n� etkiledii i_lerde deerlidir."], ["Sosyal medya paketi", "Sunum teslimi", "K1sa video"], "0lgili ara�lar1 a�", "/tr/tools") ] }),
          section("Doru se�imi nas1l yapars1n?", ["�nce ne satt11n1 netle_tir: yaz1 m1, ara_t1rma m1, g�rsel mi, video mu? Sonra bu �1kt1y1 en h1zl1 ve en tutarl1 �retecek arac1 se�.", "Pop�ler g�r�nen arac1 almak yerine teklif modeline g�re karar vermek daha mant1kl1d1r." ]),
          section("Ger�ek�i kullan1m senaryolar1", ["Bir freelancer haftal1k blog yaz1lar1n1 [Claude](/tr/tools/claude) ile daha h1zl1 taslaklayabilir. Ba_ka biri [Perplexity](/tr/tools/perplexity) ile rakip analizi sunabilir. Bir sosyal medya y�neticisi [Canva AI](/tr/tools/canva-ai) ile ayn1 m�_teriye ekstra teslim ekleyebilir.", "Ayr1ca [2026'da internetten para kazand1ran AI ara�lar1](/tr/blog/ai-tools-to-make-money-2026) rehberi bu modeli gelir a�1s1ndan tamamlar."], { bullets: ["Blog + e-posta paketi", "Rakip analizi", "Sosyal medya kreatifi", "K1sa video repurpose"] }),
          section("Son not", ["Freelancer i�in doru ara� seti k���k ama etkili oland1r.", "Benzer _ekilde [2026'da yeni ba_layanlar i�in en mant1kl1 AI ara�lar1](/tr/blog/best-ai-tools-for-beginners-2026) ve [ChatGPT vs Claude vs Gemini kar_1la_t1rma (2026)](/tr/blog/chatgpt-vs-claude-vs-gemini) yaz1lar1 da se�im s�recini h1zland1rabilir."], { subSections: [ sub("Sonraki ad1m", ["�nce hangi hizmeti sataca1na karar ver, sonra o hizmeti h1zland1ran ara� sayfas1n1 a�."], undefined, "See details", "/tr/tools") ] })
        ]
      },
      en: {
...
,
  {
    ...
    locales: {
      tr: {
        title: "2026 en iyi �cretsiz AI ara�lar1",
        excerpt: "�cretsiz veya freemium plan1yla ger�ekten i_e yarayan AI ara�lar1n1, hangi kullan1m senaryosunda mant1kl1 olduklar1yla birlikte g�steren rehber.",
        intro: "�cretsiz AI ara�lar1 �ok t1klan1r ama �ou listede ger�ek kullan1m deeri anlat1lmaz. Bu rehberin amac1 hype �retmek deil; [ChatGPT](/tr/tools/chatgpt), [Gemini](/tr/tools/gemini), [Perplexity](/tr/tools/perplexity), [Canva AI](/tr/tools/canva-ai), [Notion AI](/tr/tools/notion-ai) ve [ElevenLabs](/tr/tools/elevenlabs) gibi ara�lar1n �cretsiz kullan1mda nerede i_e yarad11n1 net bi�imde g�stermektir.",
        categoryLabel: "�cretsiz Ara�lar",
        seoTitle: "2026 en iyi �cretsiz AI ara�lar1 | Deciply",
        seoDescription: "Ger�ekten i_e yarayan �cretsiz AI ara�lar1n1 yaz1, ara_t1rma, g�rsel ve verimlilik senaryolar1na g�re inceleyin.",
        sections: [
          section("H1zl1 �zet", ["�cretsiz planlar kusursuz deildir; ama ilk i_ ak1_1n1 kurmak, k���k denemeler yapmak ve hangi arac1n sana uyduunu g�rmek i�in �ok deerlidir.", "Genel kullan1m i�in [ChatGPT](/tr/tools/chatgpt) veya [Gemini](/tr/tools/gemini), ara_t1rma i�in [Perplexity](/tr/tools/perplexity), g�rsel teslim i�in [Canva AI](/tr/tools/canva-ai), not ve d�zen i�in [Notion AI](/tr/tools/notion-ai) ba_lang1� i�in mant1kl1 olabilir."], { comparison: { title: "�cretsiz kullan1m haritas1", items: [ { label: "Genel kullan1m", value: "ChatGPT / Gemini" }, { label: "Ara_t1rma", value: "Perplexity" }, { label: "G�rsel", value: "Canva AI" }, { label: "D�zen", value: "Notion AI" } ] } }),
          section("Bu i�erik kimler i�in?", ["D�_�k b�t�eyle ba_lamak isteyen �renciler, freelancer'lar, i�erik �reticileri ve k���k i_letme sahipleri i�in uygundur.", "�zellikle ara� test etmek isteyen ama daha ba_ta �cretli plana ge�mek istemeyen kullan1c1lar i�in faydal1d1r."], { bullets: ["B�t�esini korumak isteyenler", "0lk i_ ak1_1n1 test edenler", "Freemium ara� arayanlar"] }),
          section("En mant1kl1 �cretsiz ara�lar ve stratejiler", ["[ChatGPT](/tr/tools/chatgpt) ve [Gemini](/tr/tools/gemini) h1zl1 soru-cevap, �zet ve taslak taraf1nda g��l� bir ba_lang1� sunar. [Perplexity](/tr/tools/perplexity) kaynak odakl1 ara_t1rma gerektiinde daha anlaml1 hale gelir.", "G�rsel teslim veya sunum gerektiinde [Canva AI](/tr/tools/canva-ai) �ou kullan1c1 i�in daha pratik olabilir. �al1_ma d�zeni kurmak isteyenler i�in ise [Notion AI](/tr/tools/notion-ai) sade bir destek katman1 olabilir."], { subSections: [ sub("0lk �cretsiz i_ ak1_1", ["Ba_lang1� i�in en mant1kl1 y�ntem tek araca y�klenmek deil, k���k bir g�rev se�ip �cretsiz plan1n buna yetip yetmediini g�rmektir.", "�rnein blog tasla1, ara_t1rma �zeti veya sunum tasla1 gibi k���k teslimler �cretsiz planlarla rahat�a test edilebilir."], ["Blog tasla1", "Ara_t1rma �zeti", "Sunum tasla1"], "�cretsiz ara�lar1 g�r", "/tr/categories/free-tools"), sub("Ne zaman �cretliye ge�mek gerekir?", ["Eer �cretsiz plan ger�ekten i_e yar1yor ama limit y�z�nden ak1_ duruyorsa, �cretli plan daha mant1kl1 hale gelir.", "Ara� hen�z �cretsiz kullan1mda bile zay1f geliyorsa sorun planda deil, ara� uyumundad1r."], ["Ger�ek g�revle test", "Limit gelirse y�kselt", "Uyum zay1fsa dei_tir"], "Detaylar1 g�r", "/tr/tools") ] }),
          section("Doru se�imi nas1l yapars1n?", ["�cretsiz planda karar verirken �� _eye bak: ilk �1kt1 h1z1, kullan1m kolayl11 ve tekrar eden g�revlerde s�rt�nme seviyesi.", "Ayr1ca [2026'da internetten para kazand1ran AI ara�lar1](/tr/blog/ai-tools-to-make-money-2026) ve [Freelancer'lar i�in AI ara�lar1](/tr/blog/ai-tools-for-freelancers) yaz1lar1 �cretsiz planlar1n ger�ek i_ ak1_1ndaki yerini daha net g�sterir." ]),
          section("Ger�ek�i kullan1m senaryolar1", ["Bir �renci [Gemini](/tr/tools/gemini) ile ders �zeti �1karabilir. Bir freelancer [Perplexity](/tr/tools/perplexity) ile ilk rakip analizini haz1rlayabilir. Bir i�erik �reticisi [Canva AI](/tr/tools/canva-ai) ile basit g�rseller olu_turabilir.", "�cretsiz ara�lar dorudan para �retmez; ama ilk k���k �1kt1y1 d�_�k riskle test etmeyi m�mk�n k1lar."], { bullets: ["0lk �zet ve taslak", "0lk ara_t1rma teslimi", "0lk g�rsel i�erik", "D�_�k riskli deneme s�reci"] }),
          section("Son not", ["En iyi �cretsiz ara�, s1n1rs1z g�r�nen deil; �cretsiz planda bile seni ger�ek bir sonuca g�t�rebilen ara�t1r.", "Karar vermeden �nce ilgili tool sayfas1n1 a�1p limitler, art1lar ve kullan1m alanlar1n1 g�rmek en sal1kl1 ad1md1r."], { subSections: [ sub("Sonraki ad1m", ["�cretsiz ba_layacaksan �nce sana en yak1n kullan1m senaryosunu se�."], undefined, "Start free", "/tr/tools") ] })
        ]
      },
      en: {
...
,
  {
    ...
    locales: {
      tr: {
        title: "2026'da internetten para kazand1ran AI ara�lar1",
        excerpt: "0nternetten para kazanma taraf1nda hangi AI ara�lar1n1n daha mant1kl1 olduunu, ger�ek kullan1m senaryolar1 ve gelir modelleri �zerinden anlatan rehber.",
        intro: "AI ara�lar1 kendi ba_1na para basmaz; ama daha h1zl1 teslim, daha g��l� ara_t1rma, daha temiz g�rsel �retim ve daha geni_ i�erik paketi sunman1 salar. Bu rehber, [ChatGPT](/tr/tools/chatgpt), [Claude](/tr/tools/claude), [Perplexity](/tr/tools/perplexity), [Canva AI](/tr/tools/canva-ai), [ElevenLabs](/tr/tools/elevenlabs) ve [Runway](/tr/tools/runway) gibi ara�lar1n internetten para kazanma taraf1nda nas1l konumland11n1 g�sterir.",
        categoryLabel: "AI ile Para Kazanma",
        seoTitle: "2026'da internetten para kazand1ran AI ara�lar1 | Deciply",
        seoDescription: "0nternetten para kazanmak i�in en mant1kl1 AI ara�lar1n1 i�erik, ara_t1rma, g�rsel, video ve ses senaryolar1na g�re inceleyin.",
        sections: [
          section("H1zl1 �zet", ["Paraya en yak1n AI ara�lar1 genelde bir i_i daha h1zl1 teslim etmeyi, ayn1 tekliften daha fazla �1kt1 �retmeyi veya tek ki_ilik bir sistemi daha d�zenli y�r�tmeyi salar.", "Yaz1 ve esnek �retimde [ChatGPT](/tr/tools/chatgpt), uzun anlat1m ve d�zenli ak1_ta [Claude](/tr/tools/claude), ara_t1rma taraf1nda [Perplexity](/tr/tools/perplexity), h1zl1 g�rsel teslimde [Canva AI](/tr/tools/canva-ai), ses ve video taraf1nda ise [ElevenLabs](/tr/tools/elevenlabs) ve [Runway](/tr/tools/runway) �ne �1kabilir."], { comparison: { title: "Gelir odakl1 ara� haritas1", items: [ { label: "Yaz1 ve copy", value: "ChatGPT / Claude" }, { label: "Ara_t1rma", value: "Perplexity" }, { label: "G�rsel teslim", value: "Canva AI" }, { label: "Ses / video", value: "ElevenLabs / Runway" } ] } }),
          section("Bu i�erik kimler i�in?", ["Affiliate gelir kurmak isteyenler, freelance paket haz1rlayanlar, i�erik �reticileri, dijital �r�n deneyenler ve k���k online i_ modeli kurmak isteyenler i�in uygundur.", "�zellikle 'hangi ara� para kazand1r1r?' yerine 'hangi ara� hangi gelir modelinde i_e yarar?' diye d�_�nen kullan1c1 i�in faydal1d1r."], { bullets: ["Freelancer'lar", "Affiliate yay1nc1lar", "Dijital �r�n �reticileri", "0�erik �reticileri"] }),
          section("En mant1kl1 ara�lar ve stratejiler", ["[ChatGPT](/tr/tools/chatgpt) ve [Claude](/tr/tools/claude) blog, e-posta, landing page ve teklif metni taraf1nda g��l� olabilir. [Perplexity](/tr/tools/perplexity) ara_t1rma ve kaynak taraf1nda fark yarat1r.", "[Canva AI](/tr/tools/canva-ai) ayn1 teklife g�rsel veya sunum katman1 ekler. [ElevenLabs](/tr/tools/elevenlabs) sesli i�erik, [Runway](/tr/tools/runway) k1sa video �retimi ile farkl1 kanal gelir modellerine kap1 a�abilir."], { subSections: [ sub("0lk para kazand1ran kullan1m modelleri", ["Ba_lang1�ta en mant1kl1 modeller genelde i�erik paketi, ara_t1rma �zeti, sosyal medya kreatifi veya affiliate i�erik �retimidir.", "Bu y�zden yaz1, ara_t1rma ve hafif tasar1m ara�lar1 �ou kullan1c1 i�in ilk katman1 olu_turur."], ["0�erik paketi", "Ara_t1rma �zeti", "Affiliate i�erik", "Sosyal medya teslimi"], "Para odakl1 ara�lar1 incele", "/tr/categories/make-money-with-ai"), sub("Daha ileri seviye geni_leme", ["0lk sistem oturduktan sonra sesli mini �r�n, video repurpose, a�1klay1c1 sunum ya da daha zengin i�erik paketleri eklenebilir.", "Bu a_amada [ElevenLabs](/tr/tools/elevenlabs) ve [Runway](/tr/tools/runway) daha anlaml1 hale gelir."], ["Sesli i�erik", "Video repurpose", "Sunum destekli teslim"], "Detaylar1 g�r", "/tr/tools/elevenlabs") ] }),
          section("Doru se�imi nas1l yapars1n?", ["�nce gelir modelini se�: i�erik mi satacaks1n, ara_t1rma m1, g�rsel mi, video mu? Sonra o modeli en h1zl1 ve en s�rd�r�lebilir _ekilde destekleyen arac1 se�.", "Ayr1ca [Freelancer'lar i�in AI ara�lar1](/tr/blog/ai-tools-for-freelancers) ve [2026 en iyi �cretsiz AI ara�lar1](/tr/blog/best-free-ai-tools-2026) yaz1lar1 bu se�imi daha pratik hale getirir." ]),
          section("Ger�ek�i kullan1m senaryolar1", ["Bir yay1nc1 [Perplexity](/tr/tools/perplexity) ile kaynakl1 affiliate i�erik haz1rlayabilir. Bir freelancer [Claude](/tr/tools/claude) ile uzun blog paketleri �retebilir. Bir i�erik �reticisi [Canva AI](/tr/tools/canva-ai) ve [Runway](/tr/tools/runway) ile daha zengin �ok kanall1 teslimler haz1rlayabilir.", "Buradaki ortak nokta _udur: ara�lar geliri otomatik �retmez, ama ayn1 i_ten daha fazla kald1ra� salar."], { bullets: ["Affiliate blog i�erii", "Freelance i�erik paketi", "Ara_t1rma + sunum teslimi", "Video repurpose ak1_1"] }),
          section("Son not", ["0nternetten para kazand1ran en iyi AI arac1 diye tek bir cevap yoktur. En mant1kl1 cevap, kurmak istediin gelir modeline ve teslim tipine g�re dei_ir.", "Karar vermeden �nce ilgili tool detay sayfas1n1 a�1p art1lar, eksiler ve kullan1m senaryolar1n1 g�rmek daha g�venli bir ad1md1r."], { subSections: [ sub("Sonraki ad1m", ["�nce gelir modelini se�, sonra ona en yak1n arac1 a�."], undefined, "View tool", "/tr/tools") ] })
        ]
      },
      en: {
