    ...
    locales: {
      ...
      en: {
        ...
        sections: [
          ...
          section("The winner is not the tool, it is the system", ["In 2026, ecommerce teams win by assigning the right task to the right layer of the stack.", "For related reading, the guides on [Best AI Tools for Shopify Product Descriptions](/en/blog/best-ai-tools-for-shopify-product-descriptions-2026), [Best AI Tools for Shopify Stores](/en/blog/best-ai-tools-for-shopify-stores-2026), and [Best AI Tools for Cold Email Writing](/en/blog/best-ai-tools-for-cold-email-writing-2026) complete the picture."], { subSections: [ sub("Next step", ["Open the product copy layer first, then expand into email and visuals."], undefined, "Review tools", "/en/tools") ] })
        ]
      }
    }
  }
